...
var _useHandleResizeWrapper = _interopRequireDefault(require("./hooks/useHandleResizeWrapper"));
...
const TextArea = /*#__PURE__*/(0, _react.forwardRef)((props, ref) => {
  ...
  const {
    ...
    rest = __rest(props, ["prefixCls", "bordered", "size", "disabled", "status", "allowClear", "classNames", "rootClassName", "className", "style", "styles", "variant", "showCount"]);
  ...
  const handleResizeWrapper = (0, _useHandleResizeWrapper.default)();
